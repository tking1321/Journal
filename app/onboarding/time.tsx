...
const OPTIONS = [
  { value: '5 minutes', label: '5 minutes', desc: 'Just a quick check-in' },
  { value: '10 minutes', label: '10 minutes', desc: 'Focused reflection + goals' },
  { value: '15 minutes', label: '15 minutes', desc: 'Deep journaling + planning' },
  { value: '20+ minutes', label: '20+ minutes', desc: 'Full ritual' },
];
...
export default function TimeScreen() {
  ...
  function handleNext() {
    ...
    router.push('/onboarding/goallimit');
  }
    ...
    <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        <View style={styles.track}>
          <View style={[styles.fill, { width: `${(6 / 11) * 100}%` }]} />
        </View>
        <Text style={styles.stepLabel}>6/11</Text>
      </View>

      <Text style={styles.label}>STEP 6</Text>
      <Text style={styles.title}>How much time can you invest daily?</Text>
      <Text style={styles.subtitle}>Consistency beats intensity. We'll match your pace.</Text>
