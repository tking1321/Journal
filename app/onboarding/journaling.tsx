...
const OPTIONS = [
  ...
  },
  {
    value: 'guided',
    label: 'Guided',
    desc: 'Prompts tell me what to write',
  },
  {
    value: 'freeform',
    label: 'Freeform',
    desc: 'I write whatever comes up',
  },
  {
    value: 'voice',
    label: 'Voice notes',
    desc: 'I talk instead of write',
  },
];
...
export default function JournalingScreen() {
  ...
  function handleNext() {
    updateData({ journalingStyle: selected });
    ...
    <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        <View style={styles.track}>
          <View style={[styles.fill, { width: `${(9 / 11) * 100}%` }]} />
        </View>
        <Text style={styles.stepLabel}>9/11</Text>
      </View>

      <Text style={styles.label}>STEP 9</Text>
      <Text style={styles.title}>How do you like to write?</Text>
      <Text style={styles.subtitle}>Your journal should feel natural, not forced.</Text>
